...
* 我們可以將「Menu」的內容，拆分到「[$HOME/.config/jwm/menu](https://github.com/samwhelp/jwm-adjustment/blob/main/prototype/main/jwm-config/part/Main/asset/overlay/etc/skel/.config/jwm/menu)」，然後透過「`<Include>$HOME/.config/jwm/menu</Include>`」[這個指令加入](https://github.com/samwhelp/jwm-adjustment/blob/main/prototype/main/jwm-config/part/Main/asset/overlay/etc/skel/.jwmrc#L19)
...
拆分到「[$HOME/.config/jwm/start](https://github.com/samwhelp/jwm-adjustment/blob/main/prototype/main/jwm-config/part/Main/asset/overlay/etc/skel/.config/jwm/start)」，然後透過「`<StartupCommand>~/.config/jwm/start</StartupCommand>`」[這個指令加入](https://github.com/samwhelp/jwm-adjustment/blob/main/prototype/main/jwm-config/part/Main/asset/overlay/etc/skel/.jwmrc#L448)
