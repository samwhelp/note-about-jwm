...
關於「jwm」的設定檔，可以使用一個檔案搞定，路徑是「[~/.jwmrc](https://github.com/samwhelp/jwm-adjustment/blob/main/prototype/main/jwm-config/part/Main-Standalone/asset/overlay/etc/skel/.jwmrc)」。
